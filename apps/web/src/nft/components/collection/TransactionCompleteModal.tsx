            ...
            {showPurchasedModal && (
              <Trace
                ...
                properties={{
                  ...
                  usd_value:
                    parseFloat(ethersFormatEther(totalPurchaseValue)) *
                    ethUsdPrice,
                ...
                <Box className={styles.successModal} >
                  ...
                  <Box display="flex" flexWrap="wrap" width="full" height="min">
                    ...
                    <p className={styles.subHeading}>
                      <Trans>Udonswap has granted your wish!</Trans>
                    </p>
                  </Box>
                  ...
                  >
                    ...
                    <p className={styles.bodySmall}>
                      {txState === TxStateType.Success &&
                        ...
                        } no longer available. Udonswap instantly refunded you for this incomplete transaction. `}
                      {formatNumberOrString({
                        input: txFeeFiat,
                        type: NumberType.FiatNFTToken,
                      })}{" "}
                      was used for gas in attempt to complete this transaction.
