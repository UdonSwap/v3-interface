...
export const bannerText = t`
  This web application is provided as a tool for users to interact with the Udonswap Protocol on
  their own initiative, with no endorsement or recommendation of cryptocurrency trading activities. In doing so,
  Udonswap is not recommending that users or potential users engage in cryptoasset trading activity, and users or
