...
export function GetTheAppModal() {
  ...
  useOnClickOutside(ref, () =>
    isOpen ? closeModal(ApplicationModal.GET_THE_APP) : undefined,
  );
  ...
  return (
    <StyledModal isOpen={isOpen} maxWidth={486} slideIn>
      <Wrapper ref={ref}>
        <CloseButton
          onClick={() => closeModal(ApplicationModal.GET_THE_APP)}
        ...
        <ColumnCenter gap="xl">
          <ColumnCenter gap="sm">
            <ThemedText.H1Medium textAlign="center">
              <Trans>Download the Udonswap app</Trans>
            </ThemedText.H1Medium>
            <ThemedText.BodySecondary textAlign="center" maxWidth="400px">
              <Trans>
                Scan the QR code with your phone to download the Udonswap app
              </Trans>
            </ThemedText.BodySecondary>
          </ColumnCenter>
          <BadgeLink href="https://uniswapwallet.onelink.me/8q3y/m4i9qsez?af_qr=true">
            <StyledQRCode
              src={walletAppPromoBannerQR}
              alt="App OneLink QR code"
            />
          </BadgeLink>
